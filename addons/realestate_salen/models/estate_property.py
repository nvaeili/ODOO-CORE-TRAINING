...
# Class definition for Estate Property
class EstateProperty(models.Model):
    _name = "estate_property"
    _description = "Real Estate Sale"
    _sql_constraints = [
    ...
    garden_orientation = fields.Selection(
        [('N', 'North'), ('S', 'South'), ('Et', 'East'), ('W', 'West')],
    ...
    # Computation functions
        ...
        # "prop" is used as a reference to each individual record with the collection 'self'
